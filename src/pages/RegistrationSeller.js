...
const RegistrationSeller = () => {
  ...
  const onNonActiveBtnCustomerContainerClick = useCallback(() => {
    navigate("/registrationcustomer");
  }, [navigate]);

  return (
    <div className={styles.registrationseller}>
      ...
      <div className={styles.registration}>
        ...
        <div
          className={styles.nonactivebtncustomer}
          onClick={onNonActiveBtnCustomerContainerClick}
        >
          <div className={styles.submit}>Customer</div>
        </div>
        <div className={styles.activebtnseller}>
        ...
        <div className={styles.storename}>
          <div className={styles.confirmpasswordlb}>Store Name:</div>
          <img
            className={styles.txtbstorenameIcon}
            alt=""
            src="/txtbpassword@2x.png"
          />
        </div>
